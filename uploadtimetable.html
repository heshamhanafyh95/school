...
<div class="container">
	  <div class="panel panel-default">
	    <div class="panel-heading"><h3>Upload Timetable</h3></div>
...
<div class="container">
    <div class="row">
		...
		<div class="form-group">
			 ...
			 <label ng-switch="Grade" class="form-group">
               <div ng-switch-when="">
                 <B></B>
               </div>
             <div ng-switch-when="">
		...
		<div class="form-group">
		     <B><label>Classroom:</label></B><br>
			 <select ng-model="Classroom">
			 	<option value="">--------------</option>
             </select>
			 <label ng-switch="Classroom" class="form-group">
               <div ng-switch-when="">
                 <B></B>
               </div>
             <div ng-switch-when="">
		   ...
		   <div ng-app="plunkr" ng-controller="UploadController" class="form-group">
